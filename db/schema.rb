...
ActiveRecord::Schema.define(version: 20170109042154) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "brands", force: :cascade do |t|
    t.integer  "buy_org_id"
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buy_org_id"], name: "index_brands_on_buy_org_id", using: :btree
  end

  create_table "buy_orgs", force: :cascade do |t|
    t.string   "name"
    ...
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
    t.index ["name"], name: "index_buy_orgs_on_name", unique: true, using: :btree
  end
  ...
  create_table "proposals", force: :cascade do |t|
    ...
    t.string   "p_indicators"
    t.string   "s_objective"
    t.string   "s_indicators"
    t.integer  "lead_time"
  ...
  add_foreign_key "brands", "buy_orgs"
